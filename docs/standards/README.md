...
│   ├── README.md                            # 本文件
│   ├── security-standards.md                # 安全规范（v1.5新增）
│   ├── resource-management.md               # 资源管理规范（v1.5新增）
...
### 1. [安全规范](./security-standards.md) 🔒 **强制执行（v1.5新增）**
- OAuth/CSRF 防护
- XSS 防护
- 输入验证规范
- 边界条件检查
...
### 2. [资源管理规范](./resource-management.md) 💧 **强制执行（v1.5新增）**
